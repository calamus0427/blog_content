awesome-github-vue 是由[OpenDigg](http://www.opendigg.com/)整理并维护的Vue相关开源项目库集合。
start数目以项目数为准，这里不一定会经常更新
搬运一些我近期看到的~
...
- [element](https://github.com/ElemeFE/element) ★24418 - 饿了么出品的Vue2的web UI工具套件 
- [iview](https://github.com/iview/iview) ★13543 - 基于 Vuejs 的开源 UI 组件库,语法和ui都很简洁不输ele的好组件库
- [Vux](https://github.com/airyland/vux) ★11640 - 基于Vue和WeUI的组件库 
- [mint-ui](https://github.com/ElemeFE/mint-ui) ★10111 - Vue 2的移动UI元素 
- [vuetify](https://github.com/vuetifyjs/vuetify) ★9291 - 为移动而生的Vue JS 2组件框架 
- [muse-ui](https://github.com/museui/muse-ui) ★5566 - 三端样式一致的响应式 UI 库 
- [vue-material](https://github.com/marcosmoura/vue-material) ★5655 - 通过Vue Material和Vue 2建立精美的app应用 
- [Keen-UI](https://github.com/JosephusPaye/Keen-UI) ★3290 - 轻量级的基本UI组件合集 
- [vonic](https://github.com/wangdahoo/vonic) ★2575 - 快速构建移动端单页应用 
...
- [vue.js](https://github.com/vuejs/vue) ★87548 - 流行的轻量高效的前端组件化方案 
- [vue-element-admin](https://github.com/PanJiaChen/vue-element-admin) ★10046 - vue2管理系统模板,包括vuex、权限管理等功能越来越全面 
- [vue-admin](https://github.com/fundon/vue-admin) ★7528 - Vue管理面板框架 
- [quasar](https://github.com/quasarframework/quasar) ★5453 - 响应式网站和混合移动应用程序 
...
- [vue-layout](https://github.com/jaweii/Vue-Layout)★627 - 可视化vue布局框架
...
- [vuex](https://github.com/vuejs/vuex) ★13375 - 专为 Vue.js 应用程序开发的状态管理模式 
- [vue-loader](https://github.com/vuejs/vue-loader) ★2819 - Vue.js 针对Webpack的组件装载插件 
- [vue-validator](https://github.com/vuejs/vue-validator) ★1807 - vue的验证器插件 
- [vue-lazyload](https://github.com/hilongjw/vue-lazyload) ★2781 - 用于懒加载的Vue模块 
